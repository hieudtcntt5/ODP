...
airflow_home = config['configurations']['airflow-env']['airflow_home']
...
airflow_flower_pid_file = config['configurations']['airflow-env']['airflow_flower_pid_file']
airflow_pip_params = config['configurations']['airflow-env']['airflow_pip_params']
airflow_triggerer_pid_file = config['configurations']['airflow-env']['airflow_triggerer_pid_file']
